                                ...
                                <div class="bg-white p-3 hover:shadow">
                                    ...
                                    <div class="grid grid-cols-3">
                                        <div class="text-center my-2">
                                            ...
                                            <a href="#" class="text-main-color">{{ $admin->name }}</a>
                                        </div>
                                        {{-- <div class="text-center my-2">
                                    ...
                                    <div class="text-gray-700">
                                        <div class="grid md:grid-cols-2 text-sm">
                                            <div class="grid grid-cols-2">
                                                ...
                                                <div class="px-4 py-2"> {{ $admin->name }} </div>
                                            ...
                                            <div class="grid grid-cols-2">
                                                ...
                                                <div class="px-4 py-2">  {{ $admin->role }}</div>
                                            </div>
                                            <div class="grid grid-cols-2">
                                                <div class="px-4 py-2 font-semibold">Contact No.</div>
                                                <div class="px-4 py-2">   {{ $admin->number }}</div>
                                            </div>
                                            {{-- <div class="grid grid-cols-2">
                                            ...
                                            <div class="grid grid-cols-2">
                                                ...
                                                <div class="px-4 py-2">
                                                    <a class="text-blue-800" href="mailto:jane@example.com"> {{ $admin->email }}</a>
                                                </div>
                                            </div>
