                                ...
                                <div class="bg-white p-3 hover:shadow">
                                    ...
                                    <div class="grid grid-cols-3">
                                        <div class="text-center my-2">
                                            ...
                                            src="{{ $admin->image ? asset('storage/' . $admin->image) : asset('/avatar.jpeg') }}"
                                                alt="">

                                            <a href="#" class="text-main-color">{{ $group->name }}</a>
                                        </div>
                                        {{-- <div class="text-center my-2">
                                    ...
                                    <div class="text-gray-700">
                                        <div class="grid md:grid-cols-2 text-sm">
                                            ...
                                            <div class="grid grid-cols-2">
                                                ...
                                                @if ($chairman)
                                                <div class="px-4 py-2">
                                                    {{ $chairman->savers_surname }} {{ $chairman->savers_given_name }}
                                                </div>
                                                @endif
                                            @else
                                            <code>
                                            ...
                                            <div class="grid grid-cols-2">
                                                ...
                                                @if ($secretary)
                                                <div class="px-4 py-2">
                                                    {{ $secretary->savers_surname }} {{ $secretary->savers_given_name }}
                                                </div>
                                                @endif
                                            @else
                                            <code>
                                            ...
                                            <div class="grid grid-cols-2">
                                                ...
                                                @if ($treasurer)
                                                <div class="px-4 py-2">{{ $treasurer->savers_surname }} {{ $treasurer->savers_given_name }}</div>
                                            ...
                                            <div class="grid grid-cols-2">
                                                ...
                                                <div class="px-4 py-2">
                                                    <a class="text-blue-800" href="mailto:jane@example.com"> {{ $group->email }}</a>
                                                </div>
                                            </div>
